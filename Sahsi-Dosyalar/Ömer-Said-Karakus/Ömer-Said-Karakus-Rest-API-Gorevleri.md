...
Response: 200 OK - Kullanıcı bilgileri (Kullanıcı adı, email ve güncel skor/score) başarıyla getirildi
...
Authentication: Bearer Token gerekli (Sadece kullanıcının oturumu varsa kendi hesabını kalıcı olarak sistemden silebilir)
