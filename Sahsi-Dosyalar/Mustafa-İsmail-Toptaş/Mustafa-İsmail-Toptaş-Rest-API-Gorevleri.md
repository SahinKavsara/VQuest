...
Request Body: Yok (Kullanıcının token'ı üzerinden geçmiş logları veritabanından çekilir)
Authentication: Bearer Token gerekli
Response: 202 Accepted - Analiz başarıyla oluşturuldu / Güncellendi
...
Path Parameters:
reportId (string, required) - Silinmek istenen analiz Rapor ID'si
...
Request Body:
{
  "promptText": "Kullanıcının güçlü ve zayıf yönlerini uzman bir gözle analiz et..."
}
Authentication: Bearer Token gerekli (Yönetici yetkisi gerektirir)
Response: 200 OK - Sistem Promptu anında güncellendi


## Sistem Bildirimleri (Notification) Etkileşim Modülü
...
Authentication: Bearer Token gerekli (Yönetici yetkisi gerektirir)
Response: 201 Created - Bildirim havuzuna eklendi ve tüm kullanıcılara asenkron iletildi

6. Gelen Bildirimleri Görüntüleme
Endpoint: GET /api/notifications
Authentication: Bearer Token gerekli
Response: 200 OK - Kullanıcıya ait tüm (okunmuş ve okunmamış) bildirimler listelendi
...
Authentication: Bearer Token gerekli
Response: 200 OK - Bildirim isRead: true statüsüne çekildi
...
Authentication: Bearer Token gerekli
Response: 204 No Content - Bildirim veritabanından tamamen silindi
