...
- **Akış Adımları:**
  1. Sil ikonuna tıklama
  2. Uyarı dialog'u gösterilmesi
  3. Onaylandığında silme işleminin (API isteği) başlatılması
  4. Başarılı işlem sonrası UI listesinin güncellenmesi
- **Teknik Detaylar:**
